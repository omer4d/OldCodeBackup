...
int main()
{
    ...
    { 
        ...
        ellipsefill(buffer, (int)player.pos.x, (int)player.pos.y, PLAYER_W, PLAYER_H, makecol(0, 255, 0));
        ...
        {
           line(buffer, (int)points[i].x * 4, (int)points[i].y * 4,
                        (int)(points[i].x * 4 + normals[i].x * 10), (int)(points[i].y * 4 + normals[i].y * 10),
                        makecol(50, 50, 0));
        }
