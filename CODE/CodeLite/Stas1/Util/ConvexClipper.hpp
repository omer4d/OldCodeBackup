 ...
 * Author: Stas
 *
 * Created on November 25, 2012, 7:18 PM
 */

#ifndef CONVEXCLIPPER_HPP
#define	CONVEXCLIPPER_HPP
...
struct ConvexClipper {
    ...
    static ConvexClipper* instance;

public:
    static ConvexClipper& getInstance()
    {
        if(instance == NULL)
            instance = new ConvexClipper();
        return *instance;
    }
...
ConvexClipper* ConvexClipper::instance = NULL;
