...
int main()
{
    ...
    { 
     ...
     for(int i = 0; i < circles.size(); ++i)
        DrawVec2f::circle(buffer, circles[i], rad, makecol(0, 0, 255));
        
     for(int i = 0; i < occluders.size(); ++i)
        DrawVec2f::circle(buffer, occluders[i], rad, makecol(255, 0, 0));
     
     DrawVec2f::circle(buffer, dest, rad, makecol(0, 255, 0));
     DrawVec2f::circlefill(buffer, src, 5, makecol(255, 255, 0));
