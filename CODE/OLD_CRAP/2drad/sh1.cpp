	...
	for(int y = 0; y < dest->h; ++y)
	   for(int x = 0; x < dest->w; ++x)
	   {
              ...
              Vec2f rs(src.x + b*40.f*cos(2*M_PI*a/b), src.y + b*40.f*sin(2*M_PI*a/b));
	   	    ...
	   	    int br = (255-  (int)((float)count / n * 255.f)) / 2;
	   	      
		   PIXEL(dest, x, y) = makecol32(128 + br, 128 + br, 128 + br);
	   }
}
