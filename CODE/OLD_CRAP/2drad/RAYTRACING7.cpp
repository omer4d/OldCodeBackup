...
bool lineVsAABB(Vec2f const& p1, Vec2f const& p2,
                Vec2f const& lineMin, Vec2f const& lineMax, Vec2f const& n,
                Vec2f const& boxMin, Vec2f const& boxMax)
{
...
Node* lineVsNode(Vec2f const& p1, Vec2f const& p2,
                 Vec2f const& lineMin, Vec2f const& lineMax, Vec2f const& n,
                 Node* node)
{
 Node* res = NULL;
 ...
 if(!node->children[0])
   ...
   for(int i = 0; i < 4 && res == NULL; i++)
   {
     ...
     if(child->occupied && lineVsAABB(p1, p2, lineMin, lineMax, n, child->min, child->max))
       res = lineVsNode(p1, p2, lineMin, lineMax, n, child);
   }
   
 return res;
}

#define ANG_SUBDIV 180
    ...
    for(int y = 0; y < SCREEN_H; y++)
    {
      for(int x = 0; x < SCREEN_W; x++)
      {
        ...
        for(int i = 0; i < ANG_SUBDIV; i++)
        {
          ...
          Vec2f lineMin, lineMax, n(p1.y - p2.y, p2.x - p1.x);
          ...
          Node* res = lineVsNode(p1, p2, lineMin, lineMax, n, root);
